...
df_full[[x + '_xbar' for x in ['RC7205','loanratio',\
                               'roa','depratio','comloanratio','RC2170','bhc',\
...
righthand_ghat = r'RC7205_G_hat + loanratio_G_hat + roa_G_hat + depratio_G_hat + comloanratio_G_hat + mortratio_G_hat + consloanratio_G_hat + loanhhi_G_hat + costinc_G_hat + RC2170_G_hat + bhc_G_hat'

vars_endo = ['dum_ls','ls_tot_ta'] 

vars_z = ['num_branch'] # In list in case multiple instruments are needed to be run
...
# Save the tables
path = r'Results\FD_IV_v4_log_robust3.xlsx'
path_pcorr = r'Results\partial_corr_log_robust3.xlsx'
path_pr2 = r'Results\partial_pr2_log_robust3.xlsx'
