...
x_xbar_fd = df[['cd_pur_ta','cd_sold_ta','RC7205','loanratio','roa','depratio','comloanratio']].transform(lambda df: df - df.mean()).groupby(df.index.get_level_values(0)).transform(lambda df: df.shift(periods = 1) - df).dropna()
...
#----------------------------------------------
#----------------------------------------------    
# MODEL 3: FD IV, charge-off rates
#----------------------------------------------
#----------------------------------------------
