...
vars_endo = ['dum_ls','ls_nonsec_tot_ta'] 
...
df['dum_ls'] = np.exp((df.ls_nonsec_tot_ta > 0) * 1) - 1 #will be taken the log of later
...
dict_var_names = {'':'',
                 ...
                 'ls_nonsec_tot_ta':'Non-sec. Loan Sales/TA',
...
# Save the tables
path = r'Results\FD_IV_v5_nonsecls.xlsx'
