...
df_fd = df.groupby(df.index.get_level_values(0)).transform(lambda df: df.shift(periods = 1) - df).dropna()
...
# Save the tables
path = r'Results\FD_IV_v4_log_lsbanks.xlsx'
path_pcorr = r'Results\partial_corr_log_lsbanks.xlsx'
path_pr2 = r'Results\partial_pr2_log_lsbanks.xlsx'
