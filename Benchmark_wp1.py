...
vars_y = ['net_coff_on','npl_on','allow_tot','prov_ratio']
vars_x = ['credex_nonsec', 'reg_cap', 'loanratio', 'roa', 'depratio',\
          'comloanratio', 'mortratio','consloanratio', 'loanhhi', 'costinc',\
          'size','bhc']
vars_trans = ['credex_nonsec_recession']
...
rssdid_lsers = df[df.ls_nonsec > 0].index.get_level_values(0).tolist()
