...
## Balance the sample
id_balance = df_full.index.get_level_values(0).value_counts()[df_full.index.get_level_values(0).value_counts() == df_full.index.get_level_values(1).nunique()].index.tolist()
df_full = df_full[df_full.index.get_level_values(0).isin(id_balance)]
...
# Save the tables
path = r'Results\FD_IV_v5_balanced.xlsx'
