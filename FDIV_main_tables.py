...
''' OLD
path_list_step1 = ['Results/Main/Step_1/Step1_main_{}.csv'.format(i) for i in range(3)]
path_list_coff_step2 = ['Results/Main/Step_2/Step2_main_{}.csv'.format(i) for i in range(3)]
path_list_npl_step2 = ['Results/Main/Step_2/Step2_main_{}.csv'.format(i + 3) for i in range(3)]
...
df_results_step2, latex_results_step2 = concatResults(path_list_step2, col_label = col_label_step2,\
...
df_results_step1.to_csv('Results/Main/Step_1/Table_results_benchmark_step1.csv')

text_file_latex_results = open('Results/Main/Step_1/Table_results_benchmark_step1.tex', 'w')
text_file_latex_results.write(latex_results_step1)
text_file_latex_results.close()

df_results_step2.to_csv('Results/Main/Step_2/Table_results_benchmark.csv')
