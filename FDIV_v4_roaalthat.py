...
vars_needed = ['distance','provratio','net_coffratio_tot_ta',\
               ...
               'RC7205','loanratio','roa_alt_hat','depratio','comloanratio','RC2170',\
...
righthand_x = r'RC7205 + loanratio + roa_alt_hat + depratio + comloanratio + mortratio + consloanratio + loanhhi + RC2170 + bhc'
...
# Save the tables
path = r'Results\FD_IV_v4_log_roaalthat.xlsx'
path_pcorr = r'Results\partial_corr_log_roaalthat.xlsx'
path_pr2 = r'Results\partial_pr2_log_roaalthat.xlsx'
