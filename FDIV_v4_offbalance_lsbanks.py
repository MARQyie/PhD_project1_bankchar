...
# Save the tables
path = r'Results\FD_IV_v4_log_offbalance_lsbanks.xlsx'
path_pcorr = r'Results\partial_corr_log_offbalance_lsbanks.xlsx'
path_pr2 = r'Results\partial_pr2_log_offbalance_lsbanks.xlsx'
